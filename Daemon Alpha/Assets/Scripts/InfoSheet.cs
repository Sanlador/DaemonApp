...
public class InfoSheet
{
    ...
    public Dictionary<string, (float, float, float, float, float)> dynamicNumericalFields;
    ...
    public InfoSheet()
    {
        ...
        dynamicNumericalFields = new Dictionary<string, (float, float, float, float, float)>();
    }
